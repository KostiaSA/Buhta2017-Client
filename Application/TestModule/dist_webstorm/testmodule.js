...
Buhta.registerComponent(function (comp) {
    ...
    comp.createInstance = function () { return new TestModule.Org(); };
});
// this code is auto-generated by buhta designer 
/// <reference path="references.ts" />
/// <reference path="testcomp2.ts" />
...
Buhta.registerComponent(function (comp) {
    ...
    comp.references = ["references.ts", "testcomp2.ts"];
    comp.createInstance = function () { return new TestModule.TestComp1(); };
});
// this code is auto-generated by buhta designer 
/// <reference path="references.ts" />
/// <reference path="testcomp2.ts" />
...
Buhta.registerComponent(function (comp) {
    ...
    comp.references = ["references.ts", "testcomp2.ts"];
    comp.createInstance = function () { return new TestModule.TestModule(); };
});
// this code is auto-generated by buhta designer 
