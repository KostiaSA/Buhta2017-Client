...
(function (Buhta) {
    var DesignerApp = (function (_super) {
        ...
        DesignerApp.prototype.render = function () {
            return (React.createElement(Buhta.LayoutPanel, {renderToBody: true, className: this.renderClassName()}, React.createElement(Buhta.LayoutPane, {region: "north"}, React.createElement("div", null, "верх")), React.createElement(Buhta.LayoutPane, {region: "center"}, React.createElement(Buhta.DesignerProjectTabs, null)), React.createElement(Buhta.LayoutPane, {region: "west"}, React.createElement(Buhta.Tabs, {className: "designer-app-left-pane-tabs"}, React.createElement(Buhta.Tab, {title: "проект", id: "поект2", active: true}, React.createElement(Buhta.DesignerProjectTree, null)), React.createElement(Buhta.Tab, {title: "поиск", id: "поиск3"}, "ннн3"))), React.createElement(Buhta.LayoutPane, {region: "south"}, React.createElement("div", null, "низ"))));
        };
        return DesignerApp;
    }(Buhta.BaseComponent));
...
(function (Buhta) {
    var DesignerProjectTabs = (function (_super) {
        ...
        DesignerProjectTabs.prototype.updateStateTabs = function () {
            var _this = this;
            // добавляем новые
            if (!this.state.tabs)
                this.state.tabs = [];
