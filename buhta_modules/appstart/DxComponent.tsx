...
//    import Element = JSX.Element;
    export interface DxComponentProps {
        visible?: boolean;
//        enabled?: boolean;
    ...
    export interface DxComponentState {
        //clickCount: number;
...
//    export class BaseComponent<P extends BaseComponentProps, S extends BaseComponentState> extends React.Component<BaseComponentProps, BaseComponentState> {
    export class DxComponent<P extends DxComponentProps, S extends DxComponentState> extends React.Component<P, S> {

        constructor(props: P, context) {
            super(props, context);
            this.props = props;

            (this as any)["state"] = {classes: [], style: {}};
        }
